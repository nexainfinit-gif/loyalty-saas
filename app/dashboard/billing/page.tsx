    ...
    <div className="min-h-screen bg-surface">
      ...
      <header className="bg-white border-b border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">Facturation</h1>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.04)] overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-50 flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-gray-400 uppercase tracking-wider">Plan actuel</p>
          ...
          <div className="px-5 py-4 space-y-3">
            ...
            {restaurant.subscription_status === 'active' && restaurant.current_period_end && (
              <p className="text-sm text-gray-500">
                ...
                <span className="font-medium text-gray-700">
                  {new Date(restaurant.current_period_end).toLocaleDateString('fr-FR', {
            ...
            {restaurant.subscription_status === 'past_due' && (
              <div className="flex items-center gap-2 bg-warning-50 text-warning-700 text-sm px-3.5 py-2.5 rounded-xl">
                ...
                <p>Votre paiement a echoue. Mettez a jour votre moyen de paiement pour eviter l&apos;interruption du service.</p>
              </div>
            )}
            ...
            {restaurant.subscription_status === 'canceled' && (
              <div className="flex items-center gap-2 bg-danger-50 text-danger-700 text-sm px-3.5 py-2.5 rounded-xl">
                ...
                <p>Votre abonnement est annule. Reactivez votre plan pour continuer a utiliser toutes les fonctionnalites.</p>
              </div>
            )}
            ...
            {currentPlan && (
              <div className="pt-2">
                <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-2">Fonctionnalites incluses</p>
        ...
        {isStarter && otherPlans.length > 0 && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.04)] overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-50">
              <p className="text-sm font-semibold text-gray-900">Plans disponibles</p>
              <p className="text-xs text-gray-400 mt-0.5">Comparez les fonctionnalites et choisissez le plan adapte</p>
            </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.04)] overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-50">
            <p className="text-sm font-semibold text-gray-900">Informations de facturation</p>
          </div>
          <div className="px-5 py-4 space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-500">Moyen de paiement</span>
              <span className="text-sm text-gray-700 font-medium">
                {hasStripe ? 'Via Stripe' : 'Aucun'}
              </span>
            </div>
            <div className="flex items-center justify-between">
            ...
            {hasStripe && (
              <div className="pt-2">
                ...
                >
                  <IExternal />
                  Voir les factures et moyens de paiement sur Stripe
                </button>
              </div>
            )}
          </div>
            ...
            {[
              {
                ...
                a: isStarter
                  ? 'Cliquez sur "Upgrader" ci-dessus pour passer a un plan superieur.'
                  : 'Utilisez "Gerer l\'abonnement" pour acceder au portail Stripe et modifier votre plan.',
              },
              {
                q: 'Comment annuler mon abonnement ?',
                a: 'Accedez au portail Stripe via "Gerer l\'abonnement". Vous pourrez annuler a tout moment. L\'acces reste actif jusqu\'a la fin de la periode en cours.',
              },
              {
                q: 'Ou trouver mes factures ?',
                a: 'Toutes vos factures sont disponibles dans le portail Stripe. Cliquez sur "Voir les factures" dans la section Informations de facturation.',
              },
            ].map((item, i) => (
              <div key={i}>
