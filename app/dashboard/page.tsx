      ...
      >
        ...
        <nav className="flex-1 p-2 flex flex-col gap-0.5 overflow-y-auto">
          ...
          >
            ...
            {sidebarOpen && <span className="text-sm font-medium whitespace-nowrap">Facturation</span>}
          </a>
          ...
          >
            ...
            {sidebarOpen && <span className="text-sm font-medium whitespace-nowrap">Aide</span>}
          </a>
        </nav>
