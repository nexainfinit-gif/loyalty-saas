...
const DAYS_SHORT_KEYS = ['Dim', 'Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam']
...
export default function StaffPage() {
  ...
  const DAYS = DAYS_KEYS
  const DAYS_SHORT = DAYS_SHORT_KEYS
    ...
    <div>
      ...
      {staff.length === 0 ? (
        <p className="text-sm text-gray-400 text-center py-12">
          {t('appointmentStaff.noEmployees')}
        </p>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-1.5 text-xs text-gray-500 mb-2">
                  <Scissors size={13} />
                  {member.service_ids.length} {t('appointmentStaff.servicesLabel')}
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-2xl border border-gray-200 shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="px-4 sm:px-6 py-5 space-y-4">
              <div>
                <label className="text-xs font-medium text-gray-500 mb-1.5 block">{t('appointmentStaff.nameLabel')}</label>
                <input
                  type="text"
                  autoComplete="name"
                  value={form.name}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-medium text-gray-500 mb-1.5 block">{t('common.email')}</label>
                  <input
                    type="email"
                    autoComplete="email"
                    value={form.email}
                ...
                <div>
                  <label className="text-xs font-medium text-gray-500 mb-1.5 block">{t('common.phone')}</label>
                  <input
                    type="tel"
                    autoComplete="tel"
                    value={form.phone}
              ...
              <div>
                <label className="text-xs font-medium text-gray-500 mb-2 block">
                  {t('appointmentStaff.servicesLabel')}
                </label>
            ...
            <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-200">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  {t('appointmentStaff.hoursSubtitle')}
                </p>
              </div>
              <button
                onClick={() => setModalView('list')}
                ...
                return (
                  ...
                  >
                    ...
                    {isWorking && dayAvail ? (
                      ...
                      <span className="text-xs text-gray-400 ml-auto">{t('appointmentStaff.dayOff')}</span>
                    )}
                  </div>
                )
              })}
