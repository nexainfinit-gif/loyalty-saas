    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            {t('appointmentServices.subtitle')}
          </p>
        </div>
        <button
          onClick={openCreate}
      ...
      {filteredServices.length === 0 ? (
        <p className="text-sm text-gray-400 text-center py-12">
          {t('appointmentServices.noServices')}
        </p>
      ) : (
            ...
            <form onSubmit={handleSubmit} className="px-4 sm:px-6 py-5 space-y-4">
              <div>
                <label className="text-xs font-medium text-gray-500 mb-1.5 block">
                  {t('appointmentServices.nameLabel')}
                </label>
                <input
                  type="text"
                  value={form.name}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-medium text-gray-500 mb-1.5 block">
                    {t('appointmentServices.durationLabel')}
                  </label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="text-xs font-medium text-gray-500 mb-1.5 block">
                    {t('appointmentServices.priceLabel')}
                  </label>
                  <input
                    type="number"
                    value={form.price}
              ...
              <div>
                <label className="text-xs font-medium text-gray-500 mb-1.5 block">
                  {t('appointmentServices.categoryLabel')}
                </label>
                <select
                  value={form.category}
