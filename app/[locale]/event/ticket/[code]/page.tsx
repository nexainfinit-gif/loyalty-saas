          ...
          <div className="p-6 text-center">
            ...
            {ticket.status === 'checked_in' ? (
              ...
              <>
                ...
                {/* Billet dans Apple Wallet — même QR, dans la poche */}
                <a
                  href={`/api/event/ticket/${ticket.code}/pkpass`}
                  className="inline-flex items-center gap-2 mt-4 px-5 py-2.5 text-sm font-semibold"
                  style={{ background: '#000', color: '#fff', borderRadius: '10px' }}
                >
